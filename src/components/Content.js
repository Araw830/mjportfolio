    ...
    return (
        ...
        <div>
            <div className="flex justify-evenly items-between flex-col sm:flex-row">
                ...
                <h1 className="lg:text-justify lg:text-7xl font-extrabold text-4xl font-bold">Hi all, I'm Mayank <br/>Joshi 👋</h1>
      <p className="lg:text-justify font-bold lg:text-2xl text-gray-400 mt-2">A passionate Android developer 🚀 and Iam  <br/> a Superman having good knowledge of Java, Kotlin,python  <br/> with JavaScript / Reactjs frameworks.</p>
...
<button class="bg-purple-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg ml-4 uppercase">
  see my resume
                ...
                <div className="mt-10 h-200 w-200" ref={container}></div>
            </div>
